...
--My keymaps
map("i", "jk", "<ESC>", { desc = "Modo normal", silent = true })
map("n", ".w", "<cmd>w<cr>", { desc = "Guardar Archivo", silent = true })
...
map("n", "ldi", vim.diagnostic.open_float, { desc = "Line Diagnostics" })
map("n", "din", diagnostic_goto(true), { desc = "Next Diagnostic" })
map("n", "dip", diagnostic_goto(false), { desc = "Prev Diagnostic" })
map("n", "den", diagnostic_goto(true, "ERROR"), { desc = "Next Error" })
map("n", "dep", diagnostic_goto(false, "ERROR"), { desc = "Prev Error" })
map("n", "dwn", diagnostic_goto(true, "WARN"), { desc = "Next Warning" })
map("n", "dwp", diagnostic_goto(false, "WARN"), { desc = "Prev Warning" })
